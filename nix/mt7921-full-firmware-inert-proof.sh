...
PASSIVE_M1_TELEMETRY contract=linux-6.18.40-passive-m1-rx-v2 safe_read_registers=0xd4208,0xd4528,0xd452c consuming_mib_reads=false snapshot_boundaries=before-post-assoc-tail,first-data-timeout-1000ms positive_result=target_m1_observed_at_rx_dma negative_result=no_m1_at_rx_dma_ambiguous target_scope=pinned-ap-to-client-exact-addr1-addr2-addr3-direction-and-eapol-key-m1 behavior=best-effort-read-only-telemetry,control-flow-and-timeout-unchanged attribution_limit=independent-ap-or-over-air-witness-required
