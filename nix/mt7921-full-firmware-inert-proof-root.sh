...
@grep@ -Fx 'SOURCE_COMMIT=34acd735fdd1c232c456dfecf387875f9cb13af7' "$manifest" >/dev/null
...
@grep@ -F '"source_commit":"34acd735fdd1c232c456dfecf387875f9cb13af7"' "$identity" >/dev/null
@grep@ -F '"active_capable":true' "$identity" >/dev/null

printf 'INERT_PROOF_ROOT privilege=sudo_-n runner=%s runner_sha256=%s runner_registered_hash=%s flavor=full-firmware-production operation=run-one-shot-sae-auth source_commit=34acd735fdd1c232c456dfecf387875f9cb13af7 active_capable=true mode=%s\n' \
