...
```sh
./lab/audio/amd-hda-spike/check-phase1a
```
...
Run `sudo ./lab/audio/amd-hda-spike/run-physical`. The wrapper discovers the current BDF and IOMMU group, then validates every ID
