...
| --- | --- | --- |
| NIC capabilities and physical candidate channels | `mt7921-core::{NicCapability,CandidateChannel,candidate_channels}`, adapted from pinned Linux mt76/MT7921 | Consumed by path; combined adapter crate is GPL-2.0-only |
...
`../mt7921-core/{SOURCE-MAP.md,SOURCE-ITEMS.tsv}`.
