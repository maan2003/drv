...
| probe identity reads (`MT_HW_CHIPID`, `MT_HW_BOUND`, `MT_HW_REV`) | `mt7921/pci.c`, `mt792x_regs.h` | `read_dynamic_identity_status`, narrowed SAE preflight | adapted, tested | source-order fixture; chip/revision physical, bound pending |
