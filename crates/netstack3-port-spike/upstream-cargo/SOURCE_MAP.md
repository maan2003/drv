...
| `fidl_fuchsia_wlan_ieee80211` host subset | `sdk/fidl/fuchsia.wlan.ieee80211/{constants,fields}.fidl` | Narrow binding replacement exports only the pinned `MAX_SSID_BYTE_LEN` and `MAC_ADDR_LEN` constants required by `ieee80211`; no policy | Fuchsia BSD-2-Clause |
