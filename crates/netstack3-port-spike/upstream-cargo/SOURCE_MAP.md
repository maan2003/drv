...
| `fidl_fuchsia_wlan_ieee80211` host subset | `sdk/fidl/fuchsia.wlan.ieee80211/{channel,constants,fields}.fidl` | Narrow schema binding replacement exports the pinned constants, MAC address/BSS description, channel/band/BSS/PHY flexible enums, channel number, and fixed-size HT/VHT capability and operation records required by WLAN common; exact discriminants, unknown-value round trips, and record lengths are tested; no policy | Fuchsia BSD-2-Clause |
