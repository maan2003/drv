...
fn covered_concrete_encoders_match_native_commands() {
    ...
    assert_eq!(
        ...
        BTreeMap::from([
            ("11d-scan-start", 4),
            ("11d-scan-stop", 4),
            ("bss-color-change-enable", 3),
            ("init", 1),
            ("mgmt-tx-send", 12),
            ("obss-color-collision-config", 3),
            ("obss-spatial-reuse", 3),
            ("pdev-dfs-phyerr-offload-enable", 3),
            ("pdev-lro-config", 3),
            ("pdev-set-param", 27),
            ("peer-assoc", 3),
            ("peer-create", 6),
            ...
            ("scan-probe-request-oui", 3),
            ("scan-start", 3),
            ("set-current-country", 3),
