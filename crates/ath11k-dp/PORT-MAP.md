...
| `ath11k_dp_tx` | `dp_tx.c:83-310` | `tx::ClientDataPath::transmit`, `tx::client_tx_command_info` | ported-corrected | Generated C differential covers per-vdev fields, cookie layout, checksum policy, TID overwrite, and raw-without-cipher OPEN encryption; recording backend proves streaming-DMA sync before ring publication. |
