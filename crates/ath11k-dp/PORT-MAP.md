...
| `wcn6750_ops` QCN9074 RX descriptor accessors | `hw.c:1103-1137` | `rx::Wcn6750RxDescriptor` | wcn6750-specific | Generated C differential over arbitrary complete 384-byte descriptors covers the selected MSDU/MPDU/attention accessors, MPDU-start tag, and address-2 validity/value; every truncation is rejected. |
